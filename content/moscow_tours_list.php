    ...
    ?>
        ...
        <div class="pane features extra-features height-viewport" style="display: none;">
            <ul class="list-of-features">
                <li class="feature-1">
                    <span>Meet a local and make a new friend in Moscow. Choose your own Moscow tour guide, see the photos and read the fun facts of our Moscow guides. We can even organize a Skype call with your private guide once you book the tour. Ask your guide questions about any subject and get genuinely connected with your new local friend.</span>
                </li>
                <li class="feature-2">
                    <span>Exciting fun communication with a local on your Moscow guided tour, not just boring history lessons. Your personal tour guide focuses solely on you and makes sure you get the most out of your Moscow experience.</span>
                </li>
                <li class="feature-3">
                ...
                <li class="feature-4">
                    <span>Private Moscow tour, customized itinerary, personalized experience. Choose the sights YOU want, start the time YOU choose, go to places YOU are most interested in, ask any questions YOU have. All our attention to you, and only you.</span>
                </li>
                <li class="feature-5">
