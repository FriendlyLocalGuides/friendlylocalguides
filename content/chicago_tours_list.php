<?
    ...
    switch($city){
        ...
        case 'los-angeles': $toursListTable = 'tours_la'; break;
        case 'chicago': $toursListTable = 'tours_chicago'; break;
        case 'paris': $toursListTable = 'tours_paris'; break;
    }
    $sql_tours_list = "select * from $toursListTable";
?>
<section class="content_box tours-list_new  whiten">
    <div class="tabs clearfix">
        <h1 class="title-of-tours">Chicago tours</h1>
