    ...
    ?>
        ...
        <div class="pane features extra-features height-viewport" style="display: none;">
            <ul class="list-of-features">
                ...
                <li class="feature-9">
                    <span>Traditional American cuisine. On your tour you will try the best American food in the city experience national dishes in local cozy restaurants with traditional cuisine and interior.</span>
                </li>
                <li class="feature-10">
