<!--10 HOURS IN MOSCOW-->
<?
    $titleTour = "Top 20 must see in Saint Petersburg <br/> <span class='too_long_title'>with a Friendly Guide</span>";
...
<ul>
    <li>
        ...
        <p>
            We'll walk up Nevsky Prospect, the main street of Saint Petersburg, the oldest (almost 300 years old), one of the widest (up to 60 m) and one of the longest (4.5 km)! About 2 million people walk in Nevsky Prospect every day, and we’ll be the happiest of these 2 millions, as the ultimate St Petersburg experience is waiting for us!
        </p>
    </li>
    <li>
        <h6>Beloselsky Beloozersky Palace</h6>
        <p>
            Let’s have a look at the last private palace built on Nevsky Prospeсt in the XIX century, which was considered one of the most beautiful private residencies in St. Petersburg.
    ...
    <li>
        ...
        <p>
            ...
            There is an old joke here: ask locals if there are any non-drinkers in the city, and they will tell you there are four in St Pete - riders on Anichkov bridge, their hands busy as they are taming the horses.
    ...
    <li>
        ...
        <p>
            ...
            The Cathedral’s 136 columns, a 80m-high dome, intricate structure and interior make it one of the city's most majestс cathedrals
    ...
    <li>
        <h6>Gostiny Dvor</h6>
        <p>
            The historical symbol of St Petersburg and the city's oldest and largest shopping center can be compared to Moscow’s Gum, but Gostiny Dvor being much older – more than 100 years older. In fact, Gostiny Dvor is one of the first shopping arcades in the world, first mentioned in 1748.
    ...
    <li>
        ...
        <p>
            ...
            If you dare to climb 262 steps, you’ll be rewarded with fantastic city views and a 360 degree panorama of St Pete. Shall we?
        </p>
    </li>
    <li>
    ...
    <li>
        ...
        <p>
            ...
            Petersburg Palace Square is included in the UNESCO World Heritage List, and in all our St Petersburg tours.
        </p>
    </li>
    <li>
        <h6>Alexander Column</h6>
        <p>
            The column is a prototype of the ancient Trajan's Column in Rome. "Alexander Column". With the height of 47.5 meters and the total weight of 704 tons, the Alexander Column is… is not dug into the ground, neither it is attached to the foundation.
    ...
    <li>
        <h6>Winter Palace</h6>
        <p>
            Winter Palace has been painted in almost all colors of the rainbow. It was red and pink, and yellow. Finally, it turned into pale green in 1946, and is still wearing this mask.
    ...
    <li>
        ...
        <p>
            Moika river is one of the longest n St Petersburg with the length of 4.67 km.
    ...
    <li>
        ...
        <p>
            ...
            The inspiration for the statue dates back to XIX century, and you’ll hear about the story of Chizhi Pyzhik on the tour.
        </p>
    </li>
    <li>
        <h6>Field of Mars</h6>
    ...
    <li>
        ...
        <p>
            Amazing stories of Russian political leaders: national heroes with their own life stories, love intrigues, lessons they learnt and actions that led to a brand new Russia. We’ll talk about it on the tour.
        </p>
    </li>
</ul>
