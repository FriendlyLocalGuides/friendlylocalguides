...
<h1 class="title-of-tours">Choose your unique experience</h1>
    ...
    <figure class="tour-item">
        ...
        <figcaption>
            ...
            <div class="buttons-container">
                ...
                <a class="book_button" href="/moscow/tours/red-square-and-the-city/#book">Book tour</a>
            </div>
        </figcaption>
    </figure>
    <figure class="tour-item">
    ...
    <figure class="tour-item">
        ...
        <figcaption>
            ...
            <div class="buttons-container">
                ...
                <a class="book_button" href="/moscow/tours/izmailovo/#book">Book tour</a>
            </div>
        </figcaption>
    </figure>
    <figure class="tour-item">
	...
	<figure class="tour-item">
		<img src="/i/tours-list/2-days-in-moscow.jpg" alt="2 days in Moscow "/>
	...
	<figure class="tour-item">
		...
		<figcaption>
			...
			<div class="buttons-container">
				...
				<a class="book_button" href="/moscow/tours/airport-pickup-in-moscow/#book">Book tour</a>
			</div>
		</figcaption>
	</figure>
	<figure class="tour-item">
	...
	<figure class="tour-item">
		...
		<figcaption>
			...
			<div class="buttons-container">
				...
				<a class="book_button" href="/moscow/tours/communist-russia/#book">Book tour</a>
			</div>
		</figcaption>
	</figure>
	<figure class="tour-item">
