...
$stmt = $dbh->prepare('SELECT resetToken, resetComplete FROM members WHERE resetToken = :token');
...
if(isset($_POST['submit'])){
    ...
    if(!isset($error)){
        ...
        try {
            ...
            $stmt = $dbh->prepare("UPDATE members SET password = :hashedpassword, resetComplete = 'Yes'  WHERE resetToken = :token");
            $stmt->execute(array(
